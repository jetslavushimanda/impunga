    ...
    <div className="max-w-4xl xl:max-w-5xl 2xl:max-w-none lg:max-w-none mx-auto pb-24 animate-fade-in px-2 sm:px-4">
      ...
      {view === 'registration' && (
        <div className="max-w-xl mx-auto bg-white/95 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.06)] rounded-[2rem] p-5 sm:p-8 relative overflow-hidden animate-slide-up mt-4 sm:mt-8">
          ...
          <h2 className="text-3xl font-extrabold text-center text-gray-800 mb-3 relative z-10">Workspace Profile</h2>
          ...
          {isSubmitting ? (
            <div className="py-12 flex flex-col items-center justify-center relative z-10 text-indigo-600 animate-fade-in">
              ...
              <p className="mt-4 font-bold text-gray-800 animate-pulse text-center">Setting up your operational tools...</p>
            </div>
          ) : (
